...
//@Tag(name = "Controller notificacao", description = "Métodos HTTP das notificacao")
...
//    @PostMapping
//    @Operation(summary = "Salvar notificacao", description = "Salva uma nova notificacao.", tags = { //"Notificacoes" })
//    @ApiResponses({
//            @ApiResponse(responseCode = "200", description = "notificacao salva com sucesso"),
//            @ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
//            @ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
//    public ResponseEntity<Void> saveNotificacao(@RequestBody @Valid NotificacaoRequestDTO data) {
//        try {
...
//            @ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
//            @ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
//    public ResponseEntity<Notificacao> updateNotificacao(@RequestBody Notificacao data) {
//        try {
//            if (data.getId() > 0) {
...
//            @ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
//            @ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
//    public ResponseEntity<NotificacaoResponseDTO> getNotificacaoById(@PathVariable Long id) {
//        try {
...
//            @ApiResponse(responseCode = "404", description = "Recurso não encontrado"),
//            @ApiResponse(responseCode = "500", description = "Erro interno no servidor") })
//    public ResponseEntity<List<NotificacaoResponseDTO>> buscarPorNome(@RequestParam String notificacao) {
//        try {
//            List<NotificacaoResponseDTO> notificacaoList = repository.findByNomeContainingIgnoreCase//(notificacao)
//                    .stream()
