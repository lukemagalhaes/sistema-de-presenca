...
public record AlunoResponseDTO(Long id_aluno, Turma turma, String nome, int idade, String genero, Date dataNascimento,
        String endereco) {
    public AlunoResponseDTO(Aluno aluno) {
        this(aluno.getId_aluno(), aluno.getTurma(), aluno.getNome(), aluno.getIdade(), aluno.getGenero(),
                aluno.getDataNascimento(), aluno.getEndereco());
    }
}
